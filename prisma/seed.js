...
async function main() {
  ...
  const bruschetta = await prisma.menuItem.create({
    data: {
      ...
      price: 8.99,
      image:
        "https://images.unsplash.com/photo-1572695157366-5e585ab80baa?q=80&w=500",
      isAvailable: true,
      isVegetarian: true,
      isVegan: true,
      isDairyFree: true,
  ...
  const calamari = await prisma.menuItem.create({
    data: {
      ...
      price: 12.99,
      image:
        "https://images.unsplash.com/photo-1604909052743-94e838986d24?q=80&w=500",
      isAvailable: true,
      isPescatarian: true,
      menuId: mainMenu.id,
      categoryId: appetizerCategory.id,
  ...
  const steak = await prisma.menuItem.create({
    data: {
      name: "Ribeye Steak",
      description:
        "12oz ribeye steak with garlic butter, served with roasted potatoes and seasonal vegetables",
      price: 29.99,
      image:
        "https://images.unsplash.com/photo-1600891964092-4316c288032e?q=80&w=500",
      isAvailable: true,
      isGlutenFree: true,
      menuId: mainMenu.id,
  ...
  const salmon = await prisma.menuItem.create({
    data: {
      name: "Grilled Salmon",
      description:
        "Fresh salmon fillet grilled with lemon and herbs, served with rice pilaf and asparagus",
      price: 24.99,
      image:
  ...
  const spaghetti = await prisma.menuItem.create({
    data: {
      ...
      description:
        "Classic spaghetti with rich beef bolognese sauce and parmesan cheese",
      price: 16.99,
      image:
        "https://images.unsplash.com/photo-1622973536968-3ead9e780960?q=80&w=500",
      isAvailable: true,
      menuId: mainMenu.id,
  ...
  const tiramisu = await prisma.menuItem.create({
    data: {
      ...
      price: 8.99,
      image:
        "https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?q=80&w=500",
      isAvailable: true,
      isVegetarian: true,
      menuId: mainMenu.id,
  ...
  const chocolateLava = await prisma.menuItem.create({
    data: {
      ...
      price: 9.99,
      image:
        "https://images.unsplash.com/photo-1617303273451-ca7cad656d76?q=80&w=500",
      isAvailable: true,
      isVegetarian: true,
      menuId: mainMenu.id,
      categoryId: dessertCategory.id,
  ...
  await prisma.review.create({
    data: {
      ...
      title: "Amazing dish!",
      content:
        "The steak was cooked to perfection. Will definitely order again!",
      userId: customer.id,
      menuItemId: steak.id,
    },
  });
